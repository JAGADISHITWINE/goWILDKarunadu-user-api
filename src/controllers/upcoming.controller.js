...
async function getAllUpcoming(req, res) {
  ...
  try {
    ...
    let query = `
      ...
      FROM treks t
      LEFT JOIN trek_batches tb ON CONVERT(t.id USING utf8mb4) COLLATE utf8mb4_unicode_ci = CONVERT(tb.trek_id USING utf8mb4) COLLATE utf8mb4_unicode_ci
    ...
    conditions.push("tb.status = 'active'");
  ...
  try {
    ...
    const [treks] = await conn.execute(
      ...
      SELECT 
        ...
        END as batch_status
      FROM treks t
      INNER JOIN trek_batches tb ON CONVERT(t.id USING utf8mb4) COLLATE utf8mb4_unicode_ci = CONVERT(tb.trek_id USING utf8mb4) COLLATE utf8mb4_unicode_ci
